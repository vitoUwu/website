...
export default function CustomIcon({ name }: IconProps) {
	switch(name) {
		...
		case "anilist": 
			return (
				<svg className="fill-zinc-600 dark:fill-zinc-400" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="24" height="24" viewBox="0 0 172 172">
					<g>
						...
						<path d="M54.365,34.792 L18.331,137.351 L46.327,137.351 L52.425,119.611 L82.915,119.611 L88.875,137.351 L116.732,137.351 L80.836,34.792 L54.365,34.792 ZM58.800,96.882 L67.531,68.470 L77.094,96.882 L58.800,96.882 Z"/>
					</g>
				</svg>
			)
		case "spotify": {
